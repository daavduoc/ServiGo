...
export const Banner = () => {
  return (
    <div
      id="heroCarousel"
      className="carousel slide shadow-sm rounded mb-4 position-relative"
      ...
      <div className="carousel-inner rounded">
        <div className="carousel-item active">
          <img
            ...
            alt="Área de Salud ServiGo"
            style={{ objectFit: 'cover', height: '400px' }}
          />
          <div
            className="carousel-caption d-none d-md-flex flex-column justify-content-center h-100"
            style={{ top: 0, left: '8%', width: '40%', textAlign: 'left', zIndex: 10 }}
          >
            ...
            <div>
              <Link
                to="/buscar?area=Salud"
                className="btn btn-success btn-lg fw-bold mt-3 shadow position-relative"
                style={{ zIndex: 20 }}
              >
                Buscar Especialista
              </Link>
