  ...
  return (
    <div id="heroCarousel" className="carousel slide shadow-sm rounded mb-4 position-relative" data-bs-ride="carousel" data-bs-interval="3000">
      ...
      <div className="carousel-inner rounded">
        ...
        <div className="carousel-item active">
          ...
          <div className="carousel-caption d-none d-md-flex flex-column justify-content-center h-100" style={{ top: 0, left: '8%', width: '40%', textAlign: 'left', zIndex: 10 }}>
            ...
            <div>
              {/* Le damos position-relative y un z-index alto para asegurar el clic */}
              <button onClick={() => navigate('/buscar')} className="btn btn-success btn-lg fw-bold mt-3 shadow position-relative" style={{ zIndex: 20 }}>Buscar Especialista</button>
            </div>
          </div>
        </div>
        ...
        <div className="carousel-item">
          ...
          <div className="carousel-caption d-none d-md-flex flex-column justify-content-center h-100" style={{ top: 0, left: '8%', width: '40%', textAlign: 'left', zIndex: 10 }}>
            ...
            <div>
              <button onClick={() => navigate('/buscar')} className="btn btn-success btn-lg fw-bold mt-3 shadow position-relative" style={{ zIndex: 20 }}>Pedir Servicio</button>
            </div>
          </div>
        </div>
      ...
      <button
        ...
        data-bs-slide="prev"
        style={{ width: '5%' }} // <-- ESTO ENCAPSULA LA FLECHA
      >
